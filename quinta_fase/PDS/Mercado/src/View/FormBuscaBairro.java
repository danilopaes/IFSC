...
public class FormBuscaBairro extends javax.swing.JFrame {

    public FormBuscaBairro() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        if (tabelaBusca.getColumnModel().getColumnCount() > 0) {
            tabelaBusca.getColumnModel().getColumn(0).setMinWidth(25);
            tabelaBusca.getColumnModel().getColumn(0).setMaxWidth(25);
            tabelaBusca.getColumnModel().getColumn(1).setMinWidth(500);
            tabelaBusca.getColumnModel().getColumn(2).setMaxWidth(50);
        }
