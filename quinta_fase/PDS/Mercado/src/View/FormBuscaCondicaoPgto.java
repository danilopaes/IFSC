...
public class FormBuscaCondicaoPgto extends javax.swing.JFrame {


    public FormBuscaCondicaoPgto() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        Carregar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/Find.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ModeloBusca().setVisible(true);
            }
        });
    }
